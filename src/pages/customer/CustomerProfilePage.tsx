    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl bg-white shadow-sm overflow-hidden">
        <div className="border-b border-slate-100 px-6 py-4">
          <h2 className="text-base font-semibold text-slate-900">Lịch sử chuyến đi</h2>
        ...
        {loadingHistory ? (
          ...
          <div className="p-10 text-center">
            <p className="text-slate-500 mb-2">Bạn chưa có chuyến đi nào.</p>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-xs text-slate-400">Mã vé</div>
                    <div className="font-mono text-sm text-slate-600">#{ticket.id}</div>
                  </div>
                </div>
              </div>
            ))}
